...
1 verbose cli   'run',
1 verbose cli   'test_speaker' ]
2 info using npm@3.10.10
3 info using node@v6.9.4
4 verbose stack Error: missing script: test_speaker
...
5 verbose cwd /Users/Michal/Desktop/PersonalProjects/thekaiser/pilsudski/node_modules
6 error Darwin 16.0.0
7 error argv "/usr/local/bin/node" "/usr/local/bin/npm" "run" "test_speaker"
8 error node v6.9.4
9 error npm  v3.10.10
10 error missing script: test_speaker
